...
class LanAsset(Base, TimestampMixin):
    ...
    vendor_source: Mapped[str | None] = mapped_column(String(40), nullable=True)
    vendor_confidence: Mapped[str] = mapped_column(String(10), nullable=False, default="low", server_default="low")
    os_family: Mapped[str] = mapped_column(String(20), nullable=False, default="unknown", server_default="unknown")
    ...
    agent_mode: Mapped[str | None] = mapped_column(String(40), nullable=True)
