...
add(
    ...
    [
        (
            ...
            "KNOW-01",
            "Solo referencias/espacios de trabajo existentes se describen como disponibles.",
        ),
        (
            "Importación de vault",
            "Conocimiento",
            "Windows/Linux",
            PLANNED,
            "No aplica",
            "KNOW-02",
            "No se importan ni indexan vaults Obsidian en la versión evaluada.",
        ),
        (
            "Índice semántico gestionado",
            "Conocimiento",
            "Windows/Linux",
            PLANNED,
            "No aplica",
            "KNOW-03",
            "No se ejecuta ingestion/indexación de conocimiento en segundo plano.",
        ),
    ],
)
add(
