...
ISSUE_DATE = date(2026, 9, 26).isoformat()
...
add(
    ...
    [
        ...
        (
            "Exponer un registro de herramientas de solo lectura",
            "Gateway de herramientas AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas del registro fijo",
            "AI-11",
            "El catálogo contiene solo herramientas codificadas como lectura y reporta cero herramientas de escritura.",
        ),
        (
            "Validar cada solicitud contra su esquema",
            "Gateway de herramientas AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de esquema y entradas límite",
            "AI-12",
            "Campos adicionales, IDs desconocidos, límites excesivos y tipos inválidos se rechazan antes de acceder a servicios.",
        ),
        (
            "Aplicar RBAC y alcance a herramientas",
            "Autorización AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas API de rol y membresía",
            "AI-13",
            "Cada herramienta conserva el rol y alcance de RavenTech; investigaciones no accesibles responden como no encontradas.",
        ),
        (
            "Limitar volumen y duración de herramientas",
            "Gateway de herramientas AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de presupuesto, timeout y rate limit",
            "AI-14",
            "Llamadas, filas, duración, resultados y frecuencia por usuario/sesión/herramienta tienen límites deterministas.",
        ),
        (
            "Devolver evidencia con procedencia",
            "Gateway de herramientas AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de envelope y citas",
            "AI-15",
            "Los resultados identifican fuente, ID estable, fecha, confianza, frescura y alcance cuando están disponibles.",
        ),
        (
            "Sanear evidencia antes de persistirla o compartirla",
            "Privacidad AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de secretos y rutas",
            "AI-16",
            "Tokens, URLs con credenciales, rutas locales, argumentos, banners y claves sensibles no aparecen en resultados ni auditoría.",
        ),
        (
            "Ejecutar herramientas solo mediante el protocolo fijo",
            "Gateway de herramientas AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de protocolo y segunda ronda",
            "AI-17",
            "Solo se acepta un envelope JSON registrado por turno; solicitudes malformadas o rondas adicionales no se ejecutan.",
        ),
        (
            "Requerir consentimiento por turno para evidencia remota",
            "Privacidad AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas API/UI de consentimiento",
            "AI-18",
            "Sin aprobación explícita, el proveedor remoto recibe chat y contexto seleccionado, pero no resultados operativos de herramientas.",
        ),
        (
            "Presentar análisis por hechos, hipótesis y recomendaciones",
            "Consola AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de plantilla y panel de evidencia",
            "AI-19",
            "El contexto diferencia hechos de RavenTech e interpretación del modelo y limita las citas a evidencia suministrada.",
        ),
        (
            "Ofrecer flujos de análisis acotados",
            "Consola AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de bundles de solo lectura",
            "AI-20",
            "Los flujos de host, recursos, servicios, puertos, LAN, activo, postura, alerta e investigación seleccionan bundles fijos.",
        ),
        (
            "Mostrar actividad de herramientas en la sesión",
            "Consola AI y auditoría",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de persistencia y UI",
            "AI-21",
            "La sesión conserva actividad resumida, IDs de evidencia y errores seguros sin guardar cargas telemétricas completas.",
        ),
        (
            "Etiquetar inventario de escritorio no atestado",
            "Gateway de herramientas AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Prueba de procedencia del inventario",
            "AI-22",
            "Los procesos y servicios aportados por Tauri se marcan como informados por cliente y no verificados por backend.",
        ),
        (
            "Mantener salud del producto independiente de AI",
            "Operations Center",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de estado y readiness",
            "AI-23",
            "Fallo del gateway, modelo o proveedor degrada solo el subsistema AI y no la readiness central.",
        ),
        (
            "Informar estado operativo del gateway",
            "Operations Center",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de contrato y RBAC",
            "AI-24",
            "El estado administrativo muestra herramientas registradas, solo lectura, cero escrituras, actividad y fallos seguros.",
        ),
        (
            "Descubrir runtimes locales sin escaneo de puertos",
            "Gateway de runtimes locales",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de fixtures de runtime",
            "AI-25",
            "Ollama y LM Studio usan solo sus endpoints loopback conocidos; llama.cpp, vLLM y OpenAI-compatible requieren configuración explícita.",
        ),
        (
            "Clasificar endpoints locales y de red",
            "Seguridad de runtimes AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas IPv4, IPv6, DNS y SSRF",
            "AI-26",
            "Solo destinos loopback validados reciben solicitudes; los endpoints LAN/públicos se clasifican y bloquean.",
        ),
        (
            "Mostrar perfil de hardware disponible",
            "AI Models y hardware local",
            "Windows/Linux",
            IMPLEMENTED,
            "Fixtures Windows/Linux y lectura local",
            "AI-27",
            "La vista presenta CPU, memoria, GPU y VRAM únicamente cuando el proveedor local los informa.",
        ),
        (
            "Inventariar modelos ya instalados",
            "Catálogo local de modelos",
            "Windows/Linux",
            IMPLEMENTED,
            "Fixtures de inventario por runtime",
            "AI-28",
            "Modelo, runtime, tamaño, parámetros, cuantización, contexto y capacidades desconocidos permanecen explícitamente desconocidos.",
        ),
        (
            "Evaluar ajuste aproximado del modelo",
            "Compatibilidad hardware/modelo",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas deterministas de memoria",
            "AI-29",
            "La compatibilidad usa tamaño informado y memoria disponible, declara que es aproximada y no promete ajuste de contexto/KV-cache.",
        ),
        (
            "Aplicar Offline AI por usuario",
            "Preferencias y política de modelos",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas API de modo offline",
            "AI-30",
            "El modo desactiva descubrimiento e inferencia remotos y nunca usa fallback remoto si el modelo local falla.",
        ),
        (
            "Priorizar modelos locales compatibles",
            "Enrutamiento local-first",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de recomendación y políticas",
            "AI-31",
            "La selección explícita precede a local preferido/compatible; el remoto gratuito solo se considera si la política permite red.",
        ),
        (
            "Probar un modelo local instalado",
            "Gateway de runtimes locales",
            "Windows/Linux",
            IMPLEMENTED,
            "Prueba de respuesta mínima",
            "AI-32",
            "La prueba local separa READY básico, streaming y JSON fijo; no envía evidencia ni contexto y no ejecuta herramientas, cuyo soporte permanece desconocido.",
        ),
        (
            "Ejecutar benchmarks locales sintéticos",
            "Benchmark de modelos locales",
            "Windows/Linux",
            IMPLEMENTED,
            "Fixtures sintéticos de benchmarks",
            "AI-33",
            "Las pruebas de rendimiento, JSON, evidencia, citas, formato de herramientas, seguridad, español, inglés, Knowledge e inyección son acotadas y nunca ejecutan herramientas.",
        ),
        (
            "Conservar historial de benchmark sin respuestas",
            "Historial local de modelos",
            "Windows/Linux",
            IMPLEMENTED,
            "Inspección de esquema y persistencia",
            "AI-34",
            "Se guardan métricas, puntajes y hash de hardware; no se guardan prompts ni texto de respuesta del benchmark.",
        ),
        (
            "Aislar la falla de un runtime local",
            "Disponibilidad AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de timeout y falla",
            "AI-35",
            "Un runtime, modelo, timeout o presión de memoria no degrada análisis determinista ni habilita fallback remoto implícito.",
        ),
        (
            "Mantener instalación de modelos bajo control del operador",
            "Inventario y configuración local",
            "Windows/Linux",
            IMPLEMENTED,
            "Inspección de operaciones de runtime y paquete",
            "AI-36",
            "Descubrir, probar o comparar modelos nunca descarga pesos ni incorpora binarios de runtimes externos.",
        ),
        (
            "Enrutar tareas solo a modelos locales instalados",
            "Enrutamiento AI local por tarea",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de selección local y no-fallback remoto",
            "AI-37",
            "Los perfiles de tarea permiten rutas locales explícitas o selección automática por hardware y benchmark coincidente; cada mensaje conserva modelo solicitado, modelo real y razón segura.",
        ),
    ],
)
add(
...
add(
    ...
    [
        (
            "Registrar acciones con ejecutores fijos",
            "Action Gateway",
            "Windows/Linux",
            IMPLEMENTED,
            "Inspección de registry y pruebas API",
            "ACT-01",
            "Solo identificadores enumerados se aceptan; no hay resolución dinámica de comandos, módulos o ejecutables.",
        ),
        (
            "Crear propuesta inerte",
            "Action Gateway",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas API y de persistencia",
            "ACT-02",
            "La propuesta conserva actor, origen, objetivo, parámetros limitados, razón, riesgo, precondiciones y expiración, sin modificar el objetivo.",
        ),
        (
            "Vincular aprobación al hash de propuesta",
            "Aprobación humana",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de integridad",
            "ACT-03",
            "SHA-256 canónico incluye acción, objetivo, parámetros, precondiciones y snapshot; cualquier alteración invalida aprobación.",
        ),
        (
            "Exigir aprobación humana reciente y explícita",
            "Aprobación humana",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de RBAC/expiración",
            "ACT-04",
            "Un usuario autenticado crea una aprobación de un solo uso y TTL breve; texto del chat, incluido yes, nunca aprueba.",
        ),
        (
            "Revalidar snapshot antes de aprobación local",
            "Política y precondiciones",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas Tauri/API",
            "ACT-05",
            "La UI vuelve a enumerar el objetivo local; la discrepancia impide aprobar y requiere propuesta nueva.",
        ),
        (
            "Revalidar objetivo inmediatamente antes de ejecución",
            "Política y precondiciones",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de cambio de estado",
            "ACT-06",
            "Un estado, PID, nombre o identidad de proceso distinto al snapshot aprobado impide la ejecución.",
        ),
        (
            "Controlar servicio local enumerado",
            "Remediación local",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de provider simulado",
            "ACT-07",
            "Start/stop/restart usan SCM o provider local permitido y verifican estado posterior; servicios protegidos se bloquean.",
        ),
        (
            "Terminar proceso por identidad estable",
            "Remediación local",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de proceso temporal y PID reutilizado",
            "ACT-08",
            "Solo un proceso local no protegido coincide por PID, nombre y hora de inicio/creación; nunca se termina por PID aislado.",
        ),
        (
            "Reconocer alerta existente",
            "Alertas",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de aprobación y estado",
            "ACT-09",
            "La alerta seleccionada permanece en historial y solo cambia a leída después de acción aprobada.",
        ),
        (
            "Aplicar decisión de confianza LAN",
            "Monitoring LAN",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de baseline/snapshot",
            "ACT-10",
            "Authorize/reject/needs-review operan solo en activo existente y verifican un estado representable por su fuente.",
        ),
        (
            "Solicitar discovery LAN limitado",
            "Monitoring LAN",
            "Windows/Linux",
            IMPLEMENTED,
            "Prueba de job allowlist",
            "ACT-11",
            "Solo CIDR privados configurados y el handler de discovery existente se encolan; no se aceptan redes suministradas libremente.",
        ),
        (
            "Solicitar observación de servicio autorizada",
            "Monitoring LAN",
            "Windows/Linux",
            IMPLEMENTED,
            "Prueba de autorización y job",
            "ACT-12",
            "Solo activo autorizado usa puertos, límites y comprobaciones TCP existentes; no se autentica ni envían comandos.",
        ),
        (
            "Solicitar recálculo de postura o reintento seguro",
            "Operaciones",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de handler/job allowlist",
            "ACT-13",
            "Solo asset/job existente y handler permitido con precondiciones actuales puede encolarse.",
        ),
        (
            "Verificar postcondición y registrar resultado",
            "Auditoría y cronología",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de verificación y timeline",
            "ACT-14",
            "El resultado indica verificado/fallido con razón segura y actor aprobador; la cronología no afirma éxito no verificado.",
        ),
        (
            "Impedir replay y acciones concurrentes",
            "Idempotencia y concurrencia",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas de replay y lock",
            "ACT-15",
            "La aprobación se consume una vez y un lease bloquea acciones nativas simultáneas sobre el mismo objetivo.",
        ),
        (
            "Permitir al modelo proponer sin ejecutar",
            "Consola AI",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas con modelo simulado",
            "ACT-16",
            "AI puede crear como máximo una propuesta pendiente tras petición explícita; tools de aprobación/ejecución expuestas al modelo son cero.",
        ),
        (
            "Desactivar globalmente el Action Gateway",
            "Política administrativa",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas API/RBAC",
            "ACT-17",
            "Solo un administrador cambia el switch y las propuestas/aprobaciones pendientes se invalidan al deshabilitarlo.",
        ),
        (
            "Rechazar endpoints operativos que evaden aprobación",
            "Política de ejecución",
            "Windows/Linux",
            IMPLEMENTED,
            "Pruebas API negativas",
            "ACT-18",
            "Rutas legacy de writes locales, acknowledgement, decisiones LAN, checks y retry directo devuelven denegación segura.",
        ),
    ],
)
add(
...
add_nfr(
    ...
    [
        (
            "Aprobación sin inferencia conversacional",
            ...
            "Windows/Linux",
            "Pruebas de chat y API negativa",
            "ACT-NFR-01",
            "AI no aprueba ni ejecuta; chat yes no cambia estado.",
        ),
        (
            "Alcance de ejecutores",
            "Los ejecutores se limitan a operaciones fijas locales o handlers internos allowlist.",
            "Windows/Linux",
            "Inspección estática/API",
            "ACT-NFR-02",
            "No shell, eval/exec, import dinámico, ejecutable arbitrario ni operación remota.",
        ),
        (
            "Denegar objetivos protegidos por defecto",
            "Objetivos de SO, desktop y runtime RavenTech protegidos; identidad incompleta o ambigua se rechaza.",
            "Windows/Linux",
            "Pruebas provider simuladas",
            "ACT-NFR-03",
            "Proceso/service desconocido no es accionable y PID reutilizado se rechaza.",
        ),
        (
            "Revalidación fail-safe",
            "Una discrepancia de snapshot, expiry, hash, role, policy o precondición impide ejecutar.",
            "Windows/Linux",
            "Pruebas de conflicto y expiración",
            "ACT-NFR-04",
            "La respuesta no ejecuta el objetivo y pide propuesta/aprobación nueva cuando aplique.",
        ),
        (
            "Auditoría saneada",
            "La propuesta, actor aprobador, efecto y resultado se auditan sin persistir credenciales ni argumentos sensibles.",
            "Windows/Linux",
            "Escaneo de esquema y tests de secretos",
            "ACT-NFR-05",
            "Los logs y metadata excluyen JWT, contraseñas, tokens, argumentos y comandos.",
        ),
    ],
)
add_nfr(
...
add_nfr(
    ...
    [
        ...
        (
            ...
            "Windows/Linux",
            "Inspección estática y pruebas de denegación",
            "AI-NFR-05",
            "No se ejecutan shell, SQL, Python, archivos, HTTP arbitrario, administración remota ni acciones de escritura.",
        ),
        (
            "Límites de ejecución y memoria",
            "Cada turno limita llamadas, filas, tiempo, frecuencia y tamaño serializado de evidencia.",
            "Windows/Linux",
            "Pruebas de budget, rate limit y resultado",
            "AI-NFR-06",
            "Solicitudes repetidas, saturación, timeout o cancelación no producen loops ni resultados sin límite.",
        ),
        (
            "Consentimiento remoto granular",
            "La autorización para transmitir evidencia operativa a un modelo remoto aplica a un turno y a categorías visibles.",
            "Windows/Linux",
            "Prueba de flujo remoto con y sin consentimiento",
            "AI-NFR-07",
            "Sin consentimiento no se ejecuta ni comparte evidencia operativa con el proveedor remoto.",
        ),
        (
            "Minimización de auditoría AI",
            "La auditoría conserva identificadores, resultado, duración y conteos seguros sin payload crudo de herramienta.",
            "Windows/Linux",
            "Inspección de registros y pruebas de sanitización",
            "AI-NFR-08",
            "Los metadatos no contienen prompts completos, telemetría, secretos ni rutas locales.",
        ),
        (
            "Protección SSRF de runtimes locales",
            ...
            "Windows/Linux",
            "Pruebas de URL, DNS rebinding y transporte",
            "AI-NFR-09",
            "Un endpoint externo, alias de red o resolución mixta no recibe una solicitud desde RavenTech.",
        ),
        (
            "Sin expansión de privilegios de IA local",
            ...
            "Windows/Linux",
            "Pruebas de contrato AI/Action Gateway",
            "AI-NFR-10",
            "Cero herramientas de ejecución se exponen al modelo y toda escritura requiere la aprobación humana ya vigente.",
        ),
        (
            "Offline AI fail-closed",
            ...
            "Windows/Linux",
            "Pruebas API con adaptador remoto centinela",
            "AI-NFR-11",
            "El contador de llamadas de descubrimiento/inferencia remotos permanece en cero.",
        ),
        (
            "Privacidad del perfil de hardware",
            ...
            "Windows/Linux",
            "Inspección de prompt y payload remoto",
            "AI-NFR-12",
            "Ningún proveedor remoto recibe perfil, número de serie o métricas locales de hardware automáticamente.",
        ),
        (
            "Benchmark sintético acotado",
            "El benchmark usa casos sintéticos fijos, límite por caso y total, cancelación y serialización de tamaño acotado.",
            "Windows/Linux",
            "Pruebas de timeout/cancelación y datos almacenados",
            "AI-NFR-13",
            "Prompts y respuestas no se persisten; timeout, cancelación o memoria insuficiente producen un resultado limitado y seguro.",
        ),
        (
            "No descargar modelos o runtimes automáticamente",
            ...
            "Windows/Linux",
            "Inspección de llamadas y manifiestos",
            "AI-NFR-14",
            "Ninguna ruta de refresh, test o benchmark inicia descarga, instalación o exposición en LAN.",
        ),
        (
            "Enrutamiento local auditable",
            ...
            "Windows/Linux",
            "Pruebas de política y serialización de mensajes",
            "AI-NFR-15",
            "Una selección fallida no invoca descubrimiento ni inferencia remotos y no borra el modelo solicitado de la sesión.",
        ),
    ],
)
add_nfr(
...
def build_markdown() -> str:
    lines = [
        ...
        "|---|---|---|---|",
        f"| {DOCUMENT_VERSION} | {ISSUE_DATE} | Actualización de runtimes locales, políticas y enrutamiento por tarea, hardware y benchmarks sintéticos | Candidato de lanzamiento |",
        "",
        "## Contenido",
    ]
    ...
    for title, paragraphs in SECTIONS:
        ...
        if title == "29. Aceptación del producto y estado de validación":
            ...
            checks = [
                ...
                (
                    "AT-09 Action Gateway",
                    "Usar identidad sintética; proponer, aprobar, revalidar, ejecutar proveedor simulado y verificar resultado.",
                    "Aprobación humana RBAC/hash/snapshot-bound de un solo uso; protegidos, replay, expiración y AI self-approval se rechazan.",
                    "PASS por pruebas aisladas; acciones live no destructivas NOT RUN",
                ),
            ]
            data.extend(
                [
