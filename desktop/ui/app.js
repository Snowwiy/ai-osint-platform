...
const translations = {
  en: {
    ...
    startBackend: "Start the approved local Docker services.", startFrontend: "Start the local Vite frontend.", fixMigrations: "Use the approved platform start/check flow to resolve pending migrations.", releaseMismatchAction: "The backend release does not match 5.0.0-rc5.", runtimeReady: "Local runtime is ready.",
  ...
  es: {
    ...
    startBackend: "Inicia los servicios Docker locales aprobados.", startFrontend: "Inicia el frontend Vite local.", fixMigrations: "Usa el inicio/comprobación aprobado para resolver migraciones pendientes.", releaseMismatchAction: "La versión del backend no coincide con 5.0.0-rc5.", runtimeReady: "El entorno local está listo.",
